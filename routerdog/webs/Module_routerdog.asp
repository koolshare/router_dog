                                ...
                                <tr>
                                    <td bgcolor="#4D595D" colspan="3" valign="top">
                                        ...
                                        <div class="SimpleNote">
                                            ...
                                            <li>
                                                <a href="https://jq.qq.com/?_wv=1027&k=RgsV9riP" target="_blank"
                                                    ...
                                                    <td colspan="2">
                                                        <div class="switch_field"
                                                            ...
                                                            <label for="routerdog_enable">
                                                                <input id="routerdog_enable" class="switch"
                                                        ...
                                                        <div style="float: right;margin-top:5px;margin-right:30px;">
                                                            <a type="button"
                                                                href="https://koolshare.cn/thread-192376-1-1.html"
                                                                target="_blank" class="ks_btn"
                                                                style="cursor: pointer;margin-left:5px;border:none">使用交流</a>
                                        ...
                                        <div class="apply_gen">
                                            <input class="button_gen" id="routerdog_apply" onClick="save()"
